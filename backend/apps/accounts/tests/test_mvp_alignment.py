...
class Phase1MvpAlignmentTests(TestCase):
    ...
    def test_inbound_resolves_primary_handle_at_cridora(self):
        ...
        inc = resolve_inbound_transfer_target("Rahul@cridora")
    ...
    def test_inbound_resolves_vault_specific_public_id(self):
        j = User.objects.create_user(
            "j2@test.com",
            "pw",
            user_type=User.JEWELLER,
