...
class GoldTickerReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "hourly_gold_push_link_guest",
            "hourly_gold_push_link_authenticated",
            "rate_move_alert_title",
            "rate_move_alert_link",
            "rate_move_alert_link_guest",
            "rate_move_alert_link_authenticated",
            "gold_push_image_url",
