export const enMessages = {
  ...
  'auth.completeProfileSubheadline': 'Add your name and mobile number so jewellers can reach you on Cridora.',
  ...
  'pwa.promptRegion': 'Install Cridora app',
  'pwa.promptTitle': 'Install Cridora on your phone',
  'pwa.promptDetail': 'Add Cridora to your home screen for faster access and a full-screen experience.',
  'pwa.promptDismiss': 'Dismiss install prompt',
  'pwa.install': 'Install app',
  'pwa.iosTitle': 'Add Cridora to Home Screen',
  'pwa.iosDetail': 'Tap Share in Safari, then choose Add to Home Screen.',
