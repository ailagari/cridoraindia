export const enMessages = {
  ...
  'auth.loginSubheadline': 'Your gold record, your jeweller, your rates — pick up where you left off.',
  'auth.loginTrustNote': 'A safe place for customers and verified jeweller partners.',
  'auth.email': 'Email',
  ...
  'auth.joinTitle': 'You have been trusting jewellers with your gold for years.',
  'auth.signupSubheadline':
    'Now there is a way to keep track of all of it — simply, and for free. We keep count so you do not have to.',
  'auth.signupBenefit1': 'Every gram you save — counted and cared for',
  'auth.signupBenefit2': 'Bills and proofs stored safely',
  'auth.signupBenefit3': 'Send gold to family when the time comes',
  'auth.signupBenefit4': 'Use your gold at the jewellers you already trust',
  'auth.signupBenefit5': 'Know today\'s rate before anyone else',
  'auth.signUp': 'Sign up',
  ...
  'auth.completeProfileTitle': 'One more step',
  'auth.completeProfileSubheadline':
    'Add your name and mobile number so your jeweller can reach you — we will handle the rest.',
  'auth.profileUpdateFailed': 'Could not update profile.',
  ...
  'notifications.promptTitle': 'Stay close to your gold',
  'notifications.promptBody':
    'We will share today\'s gold rate and calm updates on your holdings — nothing noisy, just what matters to you.',
  'notifications.promptActivate': 'Turn on notifications',
  'notifications.promptDismiss': 'Dismiss notification prompt',
  'pwa.promptRegion': 'Save Cridora to your phone',
  'pwa.promptTitle': 'Put Cridora on your home screen',
  'pwa.promptDetail':
    'Your gold rate and record, every morning in one tap. Your gold passbook should always be within reach.',
  'pwa.promptDismiss': 'Dismiss install prompt',
  'pwa.install': 'Save to phone',
  'pwa.iosTitle': 'Save Cridora to your home screen',
  'pwa.iosDetail': 'Tap Share in Safari, then Add to Home Screen — your rate and record, one tap away.',
  ...
  'notifications.trayWelcomeTitle': 'We are watching the rate for you',
  'notifications.trayWelcomeBody':
    'Cridora alerts will land here — gold rate, portfolio updates, and news from your jeweller when it matters.',
